...
public class PaginationTest {
    ...
    public void lambdaPagination() {
        Page<Datasource> page = new Page<>(1, 5);
        QueryWrapper<Datasource> wrapper = new QueryWrapper<>();
//        wrapper.lambda().ge(Datasource::getName, 1).orderByAsc(ModelGroup::getId);
        wrapper.lambda().orderByAsc(Datasource::getId);
        IPage<Datasource> result = mapper.selectPage(page, wrapper);
...
//        Page<ModelGroup> page = new Page<>(1, 5);
//        IPage<ModelGroup> userIPage = mapper.selectPage(page, new QueryWrapper<User>()
...
//        Page<ModelGroup> page1 = JSON.parseObject(json, Page.class);
//        print(page1.getRecords());
//        System.out.println("json 正反序列化 end");
//
//        System.out.println("----- 自定义 XML 分页 ------");
//        MyPage<ModelGroup> myPage = new MyPage<ModelGroup>(1, 5).setSelectInt(20).setSelectStr("Jack");
